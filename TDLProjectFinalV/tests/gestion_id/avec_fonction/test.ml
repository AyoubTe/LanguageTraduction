...
let%test_unit "test6" = 
  let _ = compiler (pathFichiersRat^"test6.rat") in ()


let%test_unit "testVarG1" = 
  let _ = compiler (pathFichiersRat^"testVarG1.rat") in ()

let%test_unit "testValPDefaut" = 
  let _ = compiler (pathFichiersRat^"testValPDefaut.rat") in ()
  
let%test_unit "testVarSL" = 
  let _ = compiler (pathFichiersRat^"testVarSL.rat") in ()


let%test_unit "testErreurStaticAndDefault.rat" = 
  try 
...
let%test_unit "testOkStaticAndDefault" = 
  let _ = compiler (pathFichiersRat^"testOkStaticAndDefault.rat") in ()

let%test_unit "testVarSL2" = 
try 
let _ = compiler (pathFichiersRat^"testVarSL2.rat")
in raise ErreurNonDetectee
with
| IdentifiantNonDeclare("a") -> ()
