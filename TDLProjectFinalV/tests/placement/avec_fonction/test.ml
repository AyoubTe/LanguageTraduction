...
let%test "testVarLS_x" = 
  test (pathFichiersRat^"testVarLS.rat")  "main" ("x",1)  (2, "SB")

let%test "testVarLS_a" = 
  test (pathFichiersRat^"testVarLS.rat")  "f" ("a",1)  (3, "LB")

let%test "testVarLS_c" = 
  test (pathFichiersRat^"testVarLS.rat")  "f" ("c",1)  (0, "SB")

let%test "testVarLS_c" = 
  test (pathFichiersRat^"testVarLS.rat")  "g" ("a",1)  (1, "SB")

let%test "testValDefaut_b" = 
  test (pathFichiersRat^"testValDefaut.rat")  "adder" ("b",1)  (-1, "LB")

let%test "testValDefaut_a" = 
  test (pathFichiersRat^"testValDefaut.rat")  "adder" ("a",1)  (-2, "LB")

let%test "testPointeurFonction_p" =
  test (pathFichiersRat^"testPointeurFonction.rat")  "main" ("p",1)  (0, "SB")

(* let%test "testVarLS_f_c" = --Erreur a résoudre
  test (pathFichiersRat^"testVarLS.rat")  "f" ("c",1)  (4, "LB") *)
